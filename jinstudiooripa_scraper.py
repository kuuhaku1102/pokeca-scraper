...
BASE_URL = "https://jinstudiooripa.com/product/pokemon"
...
def scrape_items(existing_urls: set) -> List[List[str]]:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            html = page.content()
            with open("jinstudiooripa_debug.html", "w", encoding="utf-8") as f:
                f.write(html)
            browser.close()
    ...
    for item in items:
        ...
        if detail_url.startswith("/"):
            detail_url = urljoin("https://jinstudiooripa.com", detail_url)
        if image_url.startswith("/"):
            image_url = urljoin("https://jinstudiooripa.com", image_url)
